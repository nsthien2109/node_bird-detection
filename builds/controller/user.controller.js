...
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        result.map(function (e) { return (e.password = undefined); });
    ...
    UserController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, user, isExistEmail, isExistUsername, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = parseInt(request.params.id);
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this.userService.update(id, user)];
                    case 4:
                        result = _a.sent();
                        return [2 /*return*/, response.status(200).json(result)];
                    case 5:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        isExist = _a.sent();
                        if (!isExist) {
                            return [2 /*return*/, response.status(404).json({ message: 'User does not exist' })];
                        }
